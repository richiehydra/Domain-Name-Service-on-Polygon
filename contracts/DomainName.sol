...
contract DomainName is ERC721URIStorage {
    ...
    constructor(
        ...
        tld = _tld;
        console.log("%s the Domain has Initialized", tld);
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "Only Owner Withdraw Amounts");
        _;
    }

    function register(string calldata name) public payable {
        uint256 _price = price(name);
        require(msg.value >= _price, "Not Enough Matics");
    ...
    function setRecords(string calldata name, string calldata record) public {
        require(domains[name] == msg.sender, "You are Not the Owner Of Domain");
        records[name] = record;
    }
...
//contract Address:0x2BB8a2a37643525525Ca818D93473Dd87525CBA8
